...
public class AppStore {
	...
	public static final int APTOIDE = 5;
	...
	public static int detect(Context context) {
		...
		if( installer == null ) return UNKNOWN;
		else if( installer.equalsIgnoreCase("com.android.vending") ) return GOOGLE_PLAY;
		else if( installer.equalsIgnoreCase("com.amazon.venezia") ) return AMAZON;
		else if( installer.equalsIgnoreCase("com.sec.android.app.samsungapps") ) return SAMSUNG;
		else if( installer.equalsIgnoreCase("com.yandex.store") ) return YANDEX;
		else if( installer.equalsIgnoreCase("cm.aptoide.pt") ) return APTOIDE;
		else return OTHER;
	}
